            ...
            <div class="card white ">
                <div class="card-content">
                    ...
                    <ul class="collection">
                        <c:forEach var="planifications" items="${planifications}" varStatus="pStatus">
                            <li class="collection-item">${planifications.utilisateur_mail}</li>
                        </c:forEach>
                ...
                <div class="card-action">
                    <div class="row">
                        ...
                        <button class="btn waves-effect waves-light col s4 " type="Ajouter" name="action">Ajouter
                    ...
                    <ul class="collection">
                        <c:forEach var="commissions" items="${commissions}" varStatus="pStatus">
                            <li class="collection-item">${commissions.utilisateur_mail}
                                <a href="modifierdroit?id=${commissions.utilisateur_mail}"><i class="material-icons right red-text">delete</i></a></li>
                        </c:forEach>
